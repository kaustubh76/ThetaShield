...
const ORIGIN_LENS =
  process.env.THETASHIELD_ORIGIN_LENS_ADDRESS?.trim() || "0x393cBc35F3303Cbb2e83657fC2DDAd03b65Ce3A0";
const PROCESSOR_LENS =
  process.env.THETASHIELD_PROCESSOR_LENS_ADDRESS?.trim() || "0xf1EE0503F968E9E828eEBf258594bEF8C40d97a9";

const POOL_ID = "0x7395eeea4b661939d12196748d988ba1ed168e5d1b9c73094f372edf41bab9a5";
const HOOK = "0xD4b944d3b50003d0DBa0201De2828663903900C0";
const CONTROLLER = "0x20C178712A124F5B1e86206280c6672082C5C9C6";
const TRANSPORT = "0x0C36E4a7a83Bf916B10f467b95296f2E19Dca55C";
const PROCESSOR = "0x64846969b386444BFa1a2905DB6Dad319b578654";
